...
export default function P150MaxSparePartsPage() {
  ...
  const fetchProducts = async () => {
    try {
      const res = await fetch('/api/products?category=P150 Max&limit=500');
      ...
      <div className="bg-navy text-white py-12">
        <div className="container">
          <nav className="flex items-center gap-2 text-sm text-gray-300 mb-4">
            ...
            <span className="text-white">P150 Max</span>
          </nav>
          <div className="flex items-center gap-6">
            <div className="hidden md:block w-24 h-24 bg-white/10 rounded-xl p-2">
              <Image
                src="/images/products/drones/p150-max/p150-max-1.png"
                alt="P150 Max"
                width={80}
                height={80}
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-bold">P150 Max Spare Parts</h1>
